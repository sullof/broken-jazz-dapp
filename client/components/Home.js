...
export default class Home extends Base {
  ...
  render() {
    ...
    const stars = <div className={'centered big'}>
      * * *
    </div>
    ...
    const col3 = <Col className={'credits'}>
    ...
    const col4 = <Col className={'bio'}>
      ...
      <p>Francesco Sullo is a serial entrepreneur and software engineer living in San Francisco, California. Francesco
        studied Physics and has a solid background and a remarkable experience with cryptography, being the creator of
        Passpack, one of the first Host-proof Hosting web apps in the world. He also has a parallel life where he is
        mostly a painter, a writer, and a musician. You can see some of his works at <Ab
          link={'https://francesco.sullo.co'} label={'his website'}/>.</p>
