  ...
  render() {
    const col3 = (
      <Col className={"credits textBlock"}>
        ...
        <p>
          I am not a pianist, but I got help and want to thank a few amazing
          people:
        </p>
        <ul>
          <li>
            <Ab link="https://gaelkanievsky.com" label="Gael Kanievsky" /> gave
            me great everyday feedback
          </li>

          <li>
            <Ab link="http://ostinelli.net" label="Roberto Ostinelli" /> helped
            me figure out how to improve my performances and the pianos' sound
          </li>

          <li>
            <Ab link="http://www.danzemelman.com" label="Dan Zemelman" /> helped
            me shape the final form of this album, suggesting corrections and
            improvements
          </li>

          <li>
            <Ab link="http://allisonlovejoy.com" label="Allison Lovejoy" /> gave
            me great advice on how to overcome my limits and make the piano
            sound more natural
          </li>

          <li>
            <Ab link="http://davidedicillo.com" label="Davide Di Cillo" />{" "}
            helped me with the cover
          </li>
        </ul>
        <p>
          A special thank you to the unknown photographer who took the shot I
          used for the cover.
        </p>
        <p>
          I also want to give a warm thank you to{" "}
          <Ab
          ...
          Sullo, and the many others who liked my songs during the recording.
        </p>
        <p>
          I produced the tunes with Apple Logic Pro X, using the excellent{" "}
          <Ab
    ...
    const col4 = (
      <Col className={"bio textBlock"}>
        ...
        <p>
          I am a serial entrepreneur and software engineer living in San
          Francisco, California. I studied Physics and have a solid background
          and remarkable experience with cryptography, being the creator of
          Passpack – one of the first Host-proof Hosting web apps.
        </p>
        <p>
          I also have a parallel life where I am primarily a painter, writer,
          musician, and video maker. You can see some of my works at{" "}
          <Ab
